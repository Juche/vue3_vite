<template>
  <a-row ref="viewerContainer" class="demo-viewer">
    <vc-viewer>
          ...
          <div class="custom-drawings">
            <a-row>
              <a-button
                ...
                >{{ drawingActionInstance.tip.replace('绘制', '') }}</a-button
              >
              <a-button type="danger" round @click="clear">清除</a-button>
            </a-row>
          </div>
        </template>
      </vc-drawings>
      ...
      <vc-provider-terrain-cesium v-if="addTerrain" />
    </vc-viewer>
    <a-row class="demo-toolbar">
      <a-button type="danger" round @click="unload">销毁</a-button>
      <a-button type="danger" round @click="load">加载</a-button>
      <a-button type="danger" round @click="reload">重载</a-button>
      <a-checkbox v-model="editable">可编辑</a-checkbox>
      <a-checkbox v-model="addTerrain">地形</a-checkbox>
      <a-checkbox v-model="clampToGround">贴地</a-checkbox>
    </a-row>
  </a-row>
</template>
