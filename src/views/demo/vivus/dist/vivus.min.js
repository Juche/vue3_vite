  ...
  (n.prototype.TYPES = ['line', 'ellipse', 'circle', 'polygon', 'polyline', 'rect']),
    ...
    (n.prototype.scan = function (t) {
      for (var e, n, r, i = t.querySelectorAll(this.TYPES.join(',')), a = 0; a < i.length; a++)
        (n = (0, this[(e = i[a]).tagName.toLowerCase() + 'ToPath'])(this.parseAttr(e.attributes))),
        ...
        case window.HTMLObjectElement:
          (r = this),
            (t = function (t) {
              if (!r.isReady) {
                if (
                  ((r.el = e.contentDocument && e.contentDocument.querySelector('svg')), !r.el && t)
                )
    ...
    (i.prototype.mapping = function () {
      ...
      for (s = a = o = 0, e = this.el.querySelectorAll('path'), l = !1, t = 0; t < e.length; t++)
        if (((n = e[t]), !this.isInvisible(n))) {
          if (
            ((i = { el: n, length: 0, startAt: 0, duration: 0, isResizeSensitive: !1 }),
          ...
          (i.length = Math.ceil(n.getTotalLength() * h)),
            isNaN(i.length)
              ? window.console &&
                console.warn &&
                console.warn('Vivus [mapping]: cannot retrieve a path element length', n)
              : (this.map.push(i),
    ...
    (i.prototype.trace = function () {
      var t, e, n, r;
      for (
        r = this.animTimingFunction(this.currentFrame / this.frameLength) * this.frameLength, t = 0;
        t < this.map.length;
        t++
      )
